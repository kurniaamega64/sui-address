...
from suiaddr.chain.fees import estimate_fee
from suiaddr.config import WalletConfig
from suiaddr.services.sync import SyncEngine
...
def portfolio() -> None:
    ...
    click.echo(f"coin=SUI total={total} fee_hint={fee}")
